(() => {
  ...
  function removeOldCreateForm() {
    ...
    /*
     * Safety fallback in case the old markup
     * uses a different form wrapper.
     */
    if (
      oldButton &&
      !oldForm
    ...
    panel.innerHTML = `
      <div class="z7nc-head">
        ...
        <div>
          ...
          <p>
            Create and manage secure
            Client ID + Password accounts
            without requiring email.
          </p>
  ...
  async function createClient() {
    ...
    try {
      ...
      /*
       * Refresh Client Access Control
       * so the new client appears there too.
       */
      document
        .getElementById(
          "z7-cap-refresh"
  ...
  async function toggleStatus(
    ...
    const approved =
      window.confirm(
        `Are you sure you want to ${verb} this client?`
      );
